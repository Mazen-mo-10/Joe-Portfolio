...
const education = [
  {
    ...
    description:
      "Continuing my studies in Computer Science and AI, focusing on advanced algorithms, machine learning, and software engineering practices.",
  },
  {
...
const courses = [
  ...
  },
  {
    ...
    icon: "🌐",
    skills: ["ASP.NET Core", "Entity Framework", "Web APIs"],
    status: "Ongoing",
  },
  {
